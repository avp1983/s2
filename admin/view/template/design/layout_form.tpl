            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
					<?php if ($layout_module['position'] == 'content_head') { ?>
					<option value="content_head" selected="selected">Шапка</option>
					<?php } else { ?>
					<option value="content_head">Шапка</option>
					<?php } ?>
                  </select></td>
...
function addModule() {
	...
	html += '    <option value="content_head">Шапка</option>';
    html += '  </select></td>';
